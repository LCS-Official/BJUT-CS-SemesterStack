...
Outputs:
  work_selfrec_candidates/frame_eyefeature_candidates.csv
...
def feature_columns(df: pd.DataFrame) -> List[str]:
    skip = {"video_id","frame_idx","time_sec","label_closed","face_ok_on_update","roi_updated","roi_valid","roi_age","left_x","left_y","left_w","left_h","right_x","right_y","right_w","right_h"}
...
def main():
    ...
    parser.add_argument("--out_dir", default=r"C:\Users\LC\Desktop\eyeblink8\work_selfrec_candidates")
