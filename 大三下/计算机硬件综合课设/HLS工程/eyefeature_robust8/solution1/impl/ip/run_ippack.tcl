...
set Library     "hls"
set IPName      "eye_feature"
set Version     "1.0"
set DisplayName "Eye_feature"
set Revision    "2114647449"
...
set xo_kernel_name "eye_feature"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/LC/Desktop/HardWare_CD/eyefeature_robust8/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Users/LC/Desktop/HardWare_CD/eyefeature_robust8/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {eye_feature_flow_control_loop_pipe_sequential_init
...
eye_feature_flow_control_loop_pipe_sequential_init
eye_feature_flow_control_loop_pipe_sequential_init
...
eye_feature_hist0_RAM_AUTO_1R1W
...
eye_feature_regslice_both
eye_feature_regslice_both
eye_feature_Pipeline_INIT_HIST
eye_feature_Pipeline_FRAME_X
percentile_threshold_Pipeline_FIND_BIN
percentile_threshold
compute_robust_stats_Pipeline_INIT_RUNS
compute_robust_stats_Pipeline_ROBUST_COLS
compute_robust_stats_Pipeline_MAX_LOW
topk_sum_hist_Pipeline_INIT_HIST
topk_sum_hist_Pipeline_BUILD_HIST
topk_sum_hist_Pipeline_ACCUM_TOPK
topk_sum_hist
compute_robust_stats
eye_feature
}
set kernel_xo ""
set detect_deadlock_json "eye_feature_message_dict.json"

## Variables
set Top "eye_feature"
set TopNoPrefix "eye_feature"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 frame_width W 0x0 "Data signal of frame_width" {{0 32 frame_width W 0 "Bit 31 to 0 of frame_width"}}} {0x18 frame_height W 0x0 "Data signal of frame_height" {{0 32 frame_height W 0 "Bit 31 to 0 of frame_height"}}} {0x20 left_x W 0x0 "Data signal of left_x" {{0 32 left_x W 0 "Bit 31 to 0 of left_x"}}} {0x28 left_y W 0x0 "Data signal of left_y" {{0 32 left_y W 0 "Bit 31 to 0 of left_y"}}} {0x30 left_w W 0x0 "Data signal of left_w" {{0 32 left_w W 0 "Bit 31 to 0 of left_w"}}} {0x38 left_h W 0x0 "Data signal of left_h" {{0 32 left_h W 0 "Bit 31 to 0 of left_h"}}} {0x40 right_x W 0x0 "Data signal of right_x" {{0 32 right_x W 0 "Bit 31 to 0 of right_x"}}} {0x48 right_y W 0x0 "Data signal of right_y" {{0 32 right_y W 0 "Bit 31 to 0 of right_y"}}} {0x50 right_w W 0x0 "Data signal of right_w" {{0 32 right_w W 0 "Bit 31 to 0 of right_w"}}} {0x58 right_h W 0x0 "Data signal of right_h" {{0 32 right_h W 0 "Bit 31 to 0 of right_h"}}} {0x60 roi_valid W 0x0 "Data signal of roi_valid" {{0 32 roi_valid W 0 "Bit 31 to 0 of roi_valid"}}} {0x68 fixed_thresh W 0x0 "Data signal of fixed_thresh" {{0 32 fixed_thresh W 0 "Bit 31 to 0 of fixed_thresh"}}} {0x70 adapt_offset W 0x0 "Data signal of adapt_offset" {{0 32 adapt_offset W 0 "Bit 31 to 0 of adapt_offset"}}} {0x78 fixed_scale W 0x0 "Data signal of fixed_scale" {{0 32 fixed_scale W 0 "Bit 31 to 0 of fixed_scale"}}} {0x80 pixel_format W 0x0 "Data signal of pixel_format" {{0 32 pixel_format W 0 "Bit 31 to 0 of pixel_format"}}} {0x88 roi_version W 0x0 "Data signal of roi_version" {{0 32 roi_version W 0 "Bit 31 to 0 of roi_version"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 20 machine 64 combinational 0 latency 92 II x}
