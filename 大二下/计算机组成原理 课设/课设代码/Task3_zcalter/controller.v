module controller(op, func, aluop, gprsel, gprwr, extop, dmwr, wdsel, npcop, bsel, overflow,
                   clk, rst, pcwr, irwr, lb_flag, sb_flag, zero, IntReq, EXLSet, EXLClr, cp0_wen, bridge_wen, IntPc, MF, chan);
    input [5:0] op, func;
